...
export class CreateManagerDeworingDto {
  ...
  @ApiProperty({ type: String, description: 'Nombre del medicamento', example: 'Desparasitante X' })
  @IsString()
  ...
  @ApiProperty({ type: Date, description: 'Fecha de desparasitación', example: '2024-06-01' })
  @IsDate()
  fecha_desparasitacion: Date;

  @ApiProperty({ type: Date, description: 'Fecha de próxima desparasitación', example: '2024-07-01' })
  @IsDate()
  fecha_proxima: Date;
}
