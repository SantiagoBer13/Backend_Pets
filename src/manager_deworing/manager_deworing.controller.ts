...
export class ManagerDeworingController {
  constructor(private readonly managerDeworingService: ManagerDeworingService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateManagerDeworingDto: UpdateManagerDeworingDto) {
