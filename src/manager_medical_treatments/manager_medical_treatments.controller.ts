...
export class ManagerMedicalTreatmentsController {
  constructor(private readonly managerMedicalTreatmentsService: ManagerMedicalTreatmentsService) {}

  @Post()
  create(@Body() createManagerMedicalTreatmentDto: CreateManagerMedicalTreatmentDto) {
    return this.managerMedicalTreatmentsService.create(createManagerMedicalTreatmentDto);
  }
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateManagerMedicalTreatmentDto: UpdateManagerMedicalTreatmentDto) {
    return this.managerMedicalTreatmentsService.update(+id, updateManagerMedicalTreatmentDto);
  }
